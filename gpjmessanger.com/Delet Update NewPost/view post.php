...
<head><title>
    ...
    <?php
        ...
        $ptname=$_GET['ptname'];
	    	...
	    	{
             	$sql = "SELECT * FROM posts WHERE title='".$ptname."'";
        ...
        <form action="" method="POST">
            ...
            <h2 id="posttitel">Circular Title :-</h2>
                <div id="infoofpost" class="hidescroll_postdetil">   
                    <h5 id="postditel"><?php echo $row['title']; ?></h5>      
                </div>
                <div id="date_and_time">
                    <h2 id="dateofpost">Date / Time of Circular :-</h2><h3 id="valuefrombata"><?php echo $row['timedate']; ?></h3>
                    <h2 id="dateofpost1">Circular By :-</h2><h3 id="valuefrombatabyname"><?php echo $row['Uname']; ?></h3>
        
                </div>
                <h5 id="savetext">Save Circular :-</h5>   
               <input type="button" id="savebutton" value="Close" onclick="window.history.back()">
        <script>
            ...
            document.addEventListener("contextmenu",function(e){
             ...
             function looddata()
                {
                var nameofpersion="<?php echo $row['Uname']; ?>";
                var dateofpost=<?php echo $row['timedate']; ?>;
