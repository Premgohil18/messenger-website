    ...
    <body onload="buttonevent()">
        ...
        <form action="changepassword.php" method="POST">
            ...
            <div id="sign-in-page">
                ...
                <h1 id="oldpssword">Enter old Password :-</h1>
                 <input type="password" id="passWord" name="oldpassword"placeholder="Enter Password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"> <br> 
                <input type="checkbox" id="chackboxshow" onclick="Toggle()" ><br> <h1 id="showtext">Show</h1>
                
                <h1 id="oldpssword">Enter new Password :-</h1>
                <input type="password" id="newpassWord" name="newpassWord" placeholder="Enter Password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"> 
