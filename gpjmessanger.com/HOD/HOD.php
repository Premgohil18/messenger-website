...
<html>
    ...
    <head>
        ...
        ?>
        <link rel="stylesheet" type="text/css" href="HODSTYLE.css">
    ...
    <body onload="retrive_from_Database()">
        <form action="msg.php" method="POST">
            <div id="slidenote" class="hidescroll_note">
                ...
                <a href="javascript:void(0)"class="closebtn" onclick="closeNav()">&times;</a>
                    ...
                    <a href="../Delet Update NewPost/View_all_post.php">View All Circular</a>
                    <a href="../HOD/Acceptance.php">Acceptance</a>
     ...
     <?php
             ...
             if($_SESSION['UID']==$sendmsg && $_SESSION['username']==$resivmsg){
                 ?>
              <div id="chatmas32" style='width: 15vw; font-size: 1.20vw;float: left;margin-top: 1vw;background-color: rgb(206, 206, 211);  border-radius: 2vw; padding-top: 1vw;  padding-right: 1vw;  padding-left: 1vw; padding-bottom: 1vw; word-wrap: break-word; '>
                <label id="KK"><?php echo $msg;  ?></label>
 ...
 <script type="text/javascript" src="../jquery.js"></script>
            <script type="text/javascript">
                    $(document).ready(function() {
                         ...
                         $('#chatmasg').load('runtimeHOD.php');
                         var elmt= document.getElementById("chatmasg").scrollTop
                        document.getElementById("chatmasg").scrollTop +=110;
                ...
                <input id="sendbutton" name="sendbutton" type="submit" value="Send"  />
                     ...
                     <div id='chatt' style="width: 19vw;  margin-top: 1vw;  background-color: rgb(25, 1, 161); float: left;  border-radius: 2vw; word-wrap: break-word; padding-top: 1vw;padding-bottom: 1vw;  padding-left: 0.50vw;padding-right: 0.50vw;">
                        ...
                        <a  href="HOD.php?varname=Group" id="nameOFcontery"style=" text-decoration: none; color: white; font-size: 2vw; margin-left:6vw; ">Group</a>
                        </div>
                    ...
                    ?>
                        ...
                        <a  href="HOD.php?varname=<?php echo $x?>" id="nameOFcontery"style=" text-decoration: none; color: white; font-size: 2vw; margin-left:1vw;padding-top:5vw; "><?php echo $x;  ?></a>
