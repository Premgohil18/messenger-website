...
<head><title>
        ...
        $conn=mysqli_connect("localhost","root","","gpjmessenger");
    ...
    <body onload="loodDataFromDataBase()">
        ...
        <form action="updatemypost.php" method="POST" enctype="multipart/form-data">
            ...
            <h2 id="posttitel">Circular Title :-</h2>
                ...
                <textarea id="posttext" name="posttext" required><?php echo $row['title']; ?></textarea><br>
               
                <h5 id="choosefile">The Circular detail :-</h5>      
                <input type="file" id="pdfpostbutton" onclick="loodDataFromDataBase()" accept="application/pdf" name="pdfpostbutton" >
              
                <h5 id="savetext">Save Circular :-</h5>      
                <input type="submit" name="savebutton" id="savebutton" value="Update"/>
        </form>
        <script>
